...
describe 'chef-server-populator::client' do
  ...
  let(:chef_run) do
    ChefSpec::ServerRunner.new do |node, server|
      ...
      node.override['chef_server_populator']['databag'] = populator_data_bag
      server.create_data_bag(populator_data_bag, test_user_name => test_user_item,
                                                 'case' => {
                                                   'chef_server' => {
                                                     'enabled' => true,
                                                     'client_key' => '',
