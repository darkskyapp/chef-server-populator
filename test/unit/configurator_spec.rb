...
describe 'chef-server-populator::configurator' do
  ...
  let(:chef_run) {
    ChefSpec::SoloRunner.new do |node|
      ...
      node.default['chef_server_populator']['chef_server']['version'] = '12.0.5'
      node.default['chef_server_populator']['chef_server']['foo'] = 'bar'
  ...
  context 'with a specified endpoint' do
    before do
      chef_run.node.default['chef_server_populator']['endpoint'] = endpoint
